...
struct SceneFactory {
    static func makeMainFlow(superCoordinator: CoordinatorProtocol, finishDelegate: CoordinatorFinishDelegate) -> TabBarController {
        ...
        scheduleNavController.tabBarItem = UITabBarItem(title: "Schedule", image: UIImage(systemName: "calendar"), tag: 0)
        ...
        marksNavController.tabBarItem = UITabBarItem(title: "Marks", image: UIImage(systemName: "star.fill"), tag: 1)
